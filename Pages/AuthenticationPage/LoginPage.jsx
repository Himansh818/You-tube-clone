...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center bg-linear-to-br from-black via-gray-900 to-gray-800 text-white font-sans">
  <form
    onSubmit={submitHandler}
    id="loginForm"
    className="flex flex-col p-10 bg-gray-900/70 backdrop-blur-md rounded-3xl shadow-[0_0_25px_rgba(0,255,255,0.4)] w-[90%] sm:w-[400px] space-y-6 border border-cyan-500/30"
  >
